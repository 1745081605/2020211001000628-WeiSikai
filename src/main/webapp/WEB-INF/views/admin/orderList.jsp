		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>order Date</td>
					<%
						com.weisikai.model.Order o=(com.weisikai.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.weisikai.dao.UserDao userDao=new com.weisikai.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.weisikai.model.Payment.findByPaymentId(con,n);
						%>
